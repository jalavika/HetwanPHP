 ...
 * @Last Modified time: 2017-10-26 23:47:02
 */
...
class Player extends AbstractLoginEntity
{
   ...
   /**
    ...
    {
        return $this->lifePoints +  $this->getPlayerStatistics()['VITALITY']->getTotal();
    }
    ...
    {
        return $this->maximumLifePoints + $this->getPlayerStatistics()['VITALITY']->getTotal();
    }
     ...
     * @return string
     */
    public function getPlayerStatistics($useCache = true)
    {
        static $playerStatistics = null;

        if (!$useCache || $playerStatistics == null)
            $playerStatistics = \Hetwan\Helper\PlayerHelper::getPlayerStatistics($this);
    ...
    public function postLoad(\Doctrine\ORM\Event\LifecycleEventArgs $event)
    {
        ...
        $this->setInventory(\Hetwan\Helper\ItemHelper::getPlayerInventory($this->getId()));
    }
}